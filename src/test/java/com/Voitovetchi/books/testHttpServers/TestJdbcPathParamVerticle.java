...
public class TestJdbcPathParamVerticle {
  ...
  public void testGetByIsbn(VertxTestContext context) {
    httpClient.request(HttpMethod.GET, port, "localhost", "/books/" + testBook.getLong("ISBN"))
      .compose(req -> req.send().compose(HttpClientResponse::body))
      .onSuccess(buffer -> context.verify(() -> {
  ...
  public void testUpdate(VertxTestContext context) {
    httpClient.request(HttpMethod.PUT, port, "localhost", "/books/" + testBook.getLong("ISBN"))
  ...
  public void testDelete(VertxTestContext context) {
    httpClient.request(HttpMethod.DELETE, port, "localhost", "/books/" + testBook.getLong("ISBN"))
      .compose(req -> req.send().compose(HttpClientResponse::body))
